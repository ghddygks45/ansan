							...
							<div class="con">
								<div class="join_box find_box">
									<div class="find_tab_btn">
										<a href="homepage03_1.jsp">아이디 찾기</a>
										<a href="homepage03_2.jsp" class="active">패스워드 찾기</a>
									</div>
									<ul>
										<li class="bg01">
						...
						<div class="layer_popup_box" data-popup="popup1">
							<div class="popup popup_size_720" tabindex="0">
								<div class="popup_head">
									<h4 class="popup_tit">비밀번호 찾기</h4>
								</div>
								<div class="popup_content">
									<div class="popup_info bg_popup_news02">
										<strong>새로운 비밀번호를 입력해 주세요.</strong>
										<input type="text" placeholder="신규 비밀번호를 입력하세요." class="input_pw mt-0">
										<input type="text" placeholder="신규 비밀번호를 한번 더 입력하세요." class="input_pw sm-mt-7 lg-mt-10">
									</div>
