				...
				<div id="content" class="content">
					...
					<div class="cnt">
						...
						<ul class="study_hall_list">
							<li>
								<div class="img_box">
									<a href="network06_4.jsp">
										<img src="../../images/sub/img_study_hall01.jpg" alt="태권무 뮤직비디오 대공개">
									</a>
								</div>
								<div class="txt">
									<a href="network06_4.jsp">오구오구교실, 태권무 뮤직비디오 공개</a>
									<div class="info">
							...
							<li>
								...
								<div class="txt">
									<a href="network06_4.jsp">[길거리학습관] 2021년 상반기 성과영상</a>
									<div class="info">
										<span>2021.07.16</span>
										<span><strong>조회수 : </strong>1,852</span>
									</div>
							...
							<li>
								...
								<div class="txt">
									<a href="network06_4.jsp">오구오구교실, 숨겨진 이야기</a>
									<div class="info">
										<span>2021.07.16</span>
										<span><strong>조회수 : </strong>1,852</span>
									</div>
							...
							<li>
								...
								<div class="txt">
									<a href="network06_4.jsp">태권무 예고편 공개_오구오구교실</a>
									<div class="info">
										<span>2021.07.16</span>
										<span><strong>조회수 : </strong>1,852</span>
									</div>
