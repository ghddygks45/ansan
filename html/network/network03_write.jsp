		...
		<main id="container" class="container">
			<div class="inner">
				...
				<div id="content" class="content">
					...
					<div class="cnt_top">
						<h3 class="page_tit">재능기부 신청하기</h3>
						<!-- location -->
						<ul class="location">
						...
						<div class="layer_popup_box" data-popup="popup" tabindex="0">
							<div class="popup popup_size_720" tabindex="0">
								<div class="popup_head">
									<h4 class="popup_tit">평생교육 재능기부 신청완료</h4>
								</div>
								<div class="popup_content">
									<div class="top_info_box bg_info_01 lg-pb-50 sm-mb-0">
										<strong class="fwm color_black">재능기부 신청이 완료되었습니다.</strong>
										<p class="sm-mt-5 lg-mt-6">재능기부 신청 후 안산시 평생학습관 <span class="color_blue">담당자의 승인을 통해 홈페이지에 정보가
												제공</span>됩니다.</p>
									</div>
									<p class="sm-mt-10 lg-mt-15 color_blue">승인진행과정은 [마이페이지 &gt; 재능기부 신청현황]에서 확인하실 수 있습니다.</p>
									<div class="btn_wrap txt_c">
										<a href="#;" class="btn btn_default size_free bg_green mr-6">재능기부 신청현황</a>
