						...
						<div class="section">
							...
							<div class="list-board">
								<div class="board_section board_single">
									...
									<div class="info">
										<div class="tp">
											<a href="network07_2_view.jsp">안산시평생학습관 2022년 3/4분기 동아리실 대관 신청 안내</a>
								...
								<div class="board_section board_single">
									...
									<div class="info">
										<div class="tp">
											<a href="network07_2_view.jsp">[도서관] 7월 키즈시네마 신청 안내</a>
										</div>
										<div class="bm">
											<ul>
												<li>
								...
								<div class="board_section board_single">
									...
									<div class="info">
										<div class="tp">
											<a href="network07_2_view.jsp">[채용공고] 2022년 안산시평생학습관 직원(평생교육사) 채용</a>
										</div>
										<div class="bm">
											<ul>
												<li>
								...
								<div class="board_section board_single">
									...
									<div class="info">
										<div class="tp">
											<a href="network07_2_view.jsp">2022년 안산시평생학습관 평생교육사 현장실습 모집 공고</a>
										</div>
										<div class="bm">
											<ul>
												<li>
