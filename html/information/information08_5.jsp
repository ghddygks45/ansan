					...
					<div class="cnt">
						<div class="tab tab_row">
							<ul>
								...
								<li class="active"><a href="information08_5.jsp"><span>4층</span></a></li>
								<li><a href="information08_6.jsp"><span>5층</span></a></li>
							</ul>
						</div>
						<div class="section">
							<div class="img_box">
								<img src="../../images/sub/img_floor04.jpg" alt="하단에 내용 참고 바랍니다." class="pc_content">
								<img src="../../images/sub/img_floor04_m.jpg" alt="하단에 내용 참고 바랍니다." class="m_content">
								<div class="blind">
									4F 주요시설
									<ul>
										<li>401호 강의실</li>
						...
						<div class="section">
							...
							<ul class="facility_img_list">
								<li>
									<div class="img_box">
										<img src="../../images/sub/img_floor04_1.jpg" alt="401호 강의실">
									</div>
									<p>중규모 강의실로 전자교탁 및 음향장비 사용이 가능 (정원 36명)</p>
								</li>
								<li>
									<div class="img_box">
										<img src="../../images/sub/img_floor04_2.jpg" alt="401호 컴퓨터실">
									</div>
									<p>포토샵, 오피스, 코딩 등 컴퓨터 관련된 강좌를 모두 배울수 있는
										공간입니다. (정원 : 30명)</p>
								</li>
								<li>
									<div class="img_box">
										<img src="../../images/sub/img_floor04_3.jpg" alt="403호 강의실">
									</div>
									<p>
								...
								<li>
									<div class="img_box">
										<img src="../../images/sub/img_floor04_4.jpg" alt="404호 강의실">
									</div>
