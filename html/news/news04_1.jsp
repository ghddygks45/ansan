		...
		<main id="container" class="container">
			<div class="inner">
				...
				<div id="content" class="content">
					...
					<div class="cnt">
						<div class="section">
							<div class="top_info_box bg_news_01">
								<strong class="fwm color_black">
									Q&amp;A 게시판은 평생학습관 이용과 관련하여 궁금한 사항을 질문하는 공간으로 <span class="color_blue">본 게시판 성격과 맞지 않는 게시글은 사전 통보 없이
										삭제</span>될 수 있습니다.
								</strong>
								<div class="sm-mt-5 lg-mt-10">
									※ 중복된 질문에 대해서는 답변하지 않을 수 있습니다.<br class="pc_content">
									문의사항을 남겨주시면, 친절하고 신속하게 답변드리겠습니다.
								</div>
							</div>
						</div>
						<div class="section">
							<div class="tab">
								<ul>
									...
									<li><a href="#;"><span>정기교육</span></a></li>
									<li><a href="#;"><span>수시교육</span></a></li>
									<li><a href="#;"><span>상담/취업</span></a></li>
									<li><a href="#;"><span>시설이용</span></a></li>
						...
						<div class="section">
								...
								<div class="board_section board_single">
									...
									<div class="info">
										<div class="tp">
											...
											<a href="#n">[회관/시설이용] 저는 환불이 언제 진행되는지요?</a>
							...
							<div class="btn_wrap">
								<div class="r">
									<a href="news04_2.jsp" class="btn btn_default size_free bg_orange">질문과 답변 등록</a>
								</div>
							</div>
						</div>
					</div>
