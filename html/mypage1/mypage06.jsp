		...
		<main id="container" class="container">
			<div class="inner">
				...
				<div id="content" class="content">
					...
					<div class="cnt_top">
						<h3 class="page_tit">예비 평생교육사 실습 신청현황</h3>
						<!-- location -->
						<ul class="location">
					...
					<div class="cnt">
								...
								<div class="info">
									<div class="bm">
										<ul>
											...
											<li>
												<strong>실습희망기간 :</strong>
												<span>2022-07-01부터 2022-09-30까지</span>
											</li>
											<li>
												<strong>신청일 :</strong>
						...
						<div class="btn_wrap">
							<div class="r">
								<a href="mypage06_write.jsp" class="btn btn_default size_free bg_orange">예비 평생교육사 신청하기</a>
							</div>
						</div>
