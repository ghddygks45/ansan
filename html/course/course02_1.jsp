								...
								<div class="board_section">
									...
									<div class="info">
										<div class="tp">
											...
											<a href="course02_2.jsp">[특강] 재능나눔 다채움학교</a>
										</div>
										<div class="bm">
											<ul>
												<li>
								...
								<div class="board_section">
									...
									<div class="info">
										<div class="tp">
											...
											<a href="course02_2.jsp">[손뜨개] 유치원생 아비가일 뜨기 – 미니 미니 파우치</a>
										</div>
										<div class="bm">
											<ul>
												<li>
									...
									<div class="sub_info">
										...
										<div class="btn_area">
											<a href="course02_3.jsp" class="btn_apply">수강신청</a>
										</div>
									</div>
								</div>
								<div class="board_section">
									...
									<div class="info">
										<div class="tp">
											...
											<a href="course02_2.jsp">시민아고라/아동인권학_아이의 인권,부모가알아야지킨다</a>
										</div>
										<div class="bm">
											<ul>
												<li>
								...
								<div class="board_section">
									...
									<div class="info">
										<div class="tp">
											...
											<a href="course02_2.jsp">[길거리] 도자기 모빌 만들기 - 개소식 원데이 클래스</a>
										</div>
										<div class="bm">
											<ul>
												<li>
								...
								<div class="board_section">
									...
									<div class="info">
										<div class="tp">
											...
											<a href="course02_2.jsp" class="line-through">[길거리] 도자기 모빌 만들기 - 개소식 원데이
												클래스</a>
										</div>
										<div class="bm">
											<ul>
								...
								<div class="board_section">
									...
									<div class="info">
										<div class="tp">
											...
											<a href="course02_2.jsp">[인연생기]★한반도가 물에 잠긴다면...?/조천호 박사</a>
										</div>
										<div class="bm">
											<ul>
												<li>
