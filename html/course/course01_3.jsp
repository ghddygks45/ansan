					...
					<div class="cnt">
						...
						<div class="section">
							...
							<div class="board_write default_th">
								...
								<div class="row">
									<div class="div_th">수강료 면제자 선택 <span class="bold color_red">*</span><span class="blind">필수</span>
									</div>
									<div class="div_td txt_td">
										<p class="color_blue">※향후 수강료 결제 시 감면대상 확인절차가 필요합니다.</p>
										<p class="color_blue sm-mt-5 lg-mt-10">※수강료 면제 대상과 증명방법 안내</p>
										<ul class="list_dash lg-mt-3">
											<li>[국민기초생활보장법]에 따른 국민기초생활 수급권자 [국민기초생활 수급자 확인서, 신분증(본인)]</li>
											<li>[국가유공자 등 예우 및 지원에 관한 법률]에 따른 국가유고자와 유족 [국가 유공자 확인서]</li>
											<li>[한부모가족지원법]에 따른 한부모가족 보호 대상자 [한부모가족 확인서, 신분증(본인)]</li>
											<li>[장애인복지법]에 따른 등록장애인 [장애등급을 확인할 수 있는 증명서]</li>
											<li>[안산시 다자녀 지원에 관한 조례]에 따른 다자녀가정 중 해당자 [행복플러스카드(카드 명의자만 혜택)]</li>
										</ul>
									</div>
								</div>
							</div>
								...
								<div class="popup_content">
									<div class="top_info_box bg_course_02">
										...
										<div class="sm-mt-5 lg-mt-10">
											정기교육은 선착순 방식으로 교육참여가능여부가 선정됩니다
									...
									<ul class="list_dash sm-mt-10 lg-mt-15">
										<li>마이페이지(나의 강좌관리)를 통해 수강신청내역을 확인하실 수 있습니다.</li>
										<li class="color_blue fwr">신청 완료 후 3일 이내 수강료 결제를 하지 않으시면 자동 취소됩니다.</li>
										<li class="color_blue fwr">수강료 결제는 [마이페이지]를 통해서 하실 수 있습니다.</li>
									</ul>
